...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, FILE_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, SPELL_IMG, MSG_ALRT, FILE_FORWARD, MAIN_CHANNEL, LOG_CHANNEL, NOR_IMG
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, CallbackQuery, InputMediaPhoto
from pyrogram import Client, filters, enums
from pyrogram.errors import FloodWait, UserIsBlocked, MessageNotModified, PeerIdInvalid
from utils import get_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings
from database.users_chats_db import db
from database.ia_filterdb import Media1, Media2, Media3, Media4, Media5, Media6, db as clientDB, db1 as clientDB1, db2 as clientDB2, db3 as clientDB3, db4 as clientDB4, db5 as clientDB5, db6 as clientDB6, get_file_details, get_search_results, get_bad_files
...
@Client.on_message(filters.command('autofilter') & filters.user(ADMINS), group=1)
...
@Client.on_message(filters.group | filters.private & ~filters.forwarded) 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    REQ_CHANNEL = await fsub_db().get_req_channel()
    AUTH_CHANNEL = await fsub_db().get_auth_channel()
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            text=script.STATUS_TXT.format(total, users, chats, round(used_dbSize, 2), tot1, round(used_dbSize1, 2), tot2, round(used_dbSize2, 2), tot3, round(used_dbSize3, 2), tot4, round(used_dbSize4, 2), tot5, round(used_dbSize5, 2), tot6, round(used_dbSize6, 2)),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
